(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".products-slider")) new core(".products-slider__item", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".brands-slider")) new core(".brands-slider__body", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
        ...
        menuPageBurger.addEventListener("click", (function(e) {
            menuPageBurger.classList.toggle("menu-open");
            menuPageBody.classList.toggle("menu-open");
        }));
